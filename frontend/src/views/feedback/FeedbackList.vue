  ...
  <div class="feedback-list">
    ...
    >
      <el-form :model="formData" :rules="rules" ref="formRef" label-width="120px">
        ...
        >
          <el-input v-model="formData.policySuggestions" type="textarea" :rows="3" placeholder="请输入政策建议" />
        </el-form-item>
        ...
        <el-form-item 
          ...
          prop="response"
        >
          <el-input v-model="formData.response" type="textarea" :rows="3" placeholder="请输入回复内容" />
        </el-form-item>
      </el-form>
      <template #footer>
...
const loadData = async () => {
  ...
  try {
    ...
    if (searchStatus.value) {
      data = await feedbackApi.getByStatus(searchStatus.value)
      if (searchCompanyId.value) {
        data = data.filter(item => item.companyId === searchCompanyId.value)
      }
