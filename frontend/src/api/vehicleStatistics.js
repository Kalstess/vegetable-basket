...
export const vehicleStatisticsApi = {
  // 获取所有车辆统计
  getAll() {
  ...
  getByCompanyIdAndDate(companyId, statDate) {
    return request.get(`/vehicle-statistics/company/${companyId}/date`, {
      params: { statDate }
    })
  },
  ...
  generate(companyId, statDate) {
    return request.post('/vehicle-statistics/generate', null, {
      params: { companyId, statDate }
    })
  },
